...
private Map<Integer, Entity> entityTable;
  ...
  public void annotate(Annotation annotation, List<Entity> fet, Map<Integer, Entity> entitiesTable){
   
	 this.currentEntities = fet;
	 
	 this.entityTable = entitiesTable;
...
public void annotate(Annotation annotation) {
	 try {
	      ...
	      RuleBasedCorefMentionFinder finder = new RuleBasedCorefMentionFinder(currentEntities,entityTable);
